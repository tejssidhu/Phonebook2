...
namespace Phonebook.Data.Tests
{
	...
	public class UserRepositoryTests
	{
		...
		public void GetAllOnUserRepository()
		{
			...
			_users = _users.OrderBy(c => c.Username).ThenBy(n => n.Password).ToList();
			unProxiedUsers = unProxiedUsers.OrderBy(c => c.Username).ThenBy(n => n.Password).ToList();
		...
		private User UnProxy(dynamic proxiedType)
		{
			...
			user.Password = proxiedType.Password;
