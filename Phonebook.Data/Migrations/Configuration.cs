...
{
	internal sealed class Configuration : DbMigrationsConfiguration<Phonebook.Data.Context.PhonebookContext>
	{
		...
		protected override void Seed(Phonebook.Data.Context.PhonebookContext context)
		{
			...
			contactNumbers.ForEach(cn => context.ContactNumbers.AddOrUpdate(p => p.Id, cn));
			context.SaveChanges();
		}
	}
}
